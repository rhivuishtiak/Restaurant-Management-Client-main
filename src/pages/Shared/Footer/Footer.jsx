...
<footer className="footer p-10 bg-neutral text-neutral-content">
  ...
  <aside>
    ...
    FoodieFleet. <br/>
    <img className='h-12 rounded-lg w-36' src={logo} alt="" />
    </p> 
  ...
  <nav>
    ...
    <fieldset className="form-control w-80">
      ...
      <label className="label">
        <span className="label-text text-white">Give your opinion</span>
      </label> 
      <div className="relative">
        <input type="text" placeholder="Description" className="input input-bordered w-full pr-16" /> 
